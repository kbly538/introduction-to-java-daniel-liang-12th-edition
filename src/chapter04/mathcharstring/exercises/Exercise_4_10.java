...
public class Exercise_4_10 {
	...
	public static void main(String[] args) {
		...
		if (answer.toUpperCase().equals("Y")) day += 1;
		...
		if (answer.toUpperCase().equals("Y")) day += 2;
		...
		if (answer.toUpperCase().equals("Y")) day += 4;
		...
		if (answer.toUpperCase().equals("Y")) day += 8;
		...
		if (answer.toUpperCase().equals("Y")) day += 16;
