...
*/
package chapter09.ObjectsAndClasses.exercises.Exercise_09_02;

public class TestStock {
    public static void main(String[] args) {
        Stock orclStock = new Stock("ORCL", "Oracle Corporation");

        orclStock.previousClosingPrice = 34.5;
        orclStock.currentPrice = 34.35;

        System.out.println("Price change: " + orclStock.getChangePercent());
...
/* OUTPUT
Price change: -0.004366812227074194
 */