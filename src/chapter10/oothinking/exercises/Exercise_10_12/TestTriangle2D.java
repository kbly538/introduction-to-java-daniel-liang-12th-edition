...
public class TestTriangle2D {
    public static void main(String[] args) {
        ...
        Triangle2D t1 = new Triangle2D(new MyPoint(0, 20), new MyPoint(-20, 20), new MyPoint(20, -20));
        System.out.println("Area: " + t1.getArea());
        System.out.println("Perimeter: " + t1.getPerimeter());
        System.out.println("Contains point (3, 3): " + t1.contains(3, 3));
        System.out.println("Contains another triangle: " + t1.contains(new Triangle2D(
                new MyPoint(2.9, 2), new MyPoint(4, 1), new MyPoint(1, 3.4))));
        System.out.println("Overlaps another triangle: " + t1.overlaps(new Triangle2D(
...
Perimeter: 121.2899020449196
Contains point (3, 3): true
Contains another triangle: true
Overlaps another triangle: false
 */